  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1">
        ...
        {step === 2 && <Step2Experience next={next} back={back} updateData={updateData} />}
        {step === 3 && <Step3Education next={next} back={back} updateData={updateData} />}
        {step === 4 && <Step4Skills next={next} back={back} updateData={updateData} />}
        ...
        {step === 8 && <Step8Review back={back} data={formData} />}
      </div>
